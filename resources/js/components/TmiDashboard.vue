                ...
                <div class="d-flex pb-4 justify-content-between">
                    ...
                    <div class="lead mb-0 align-self-center">
                        <span class="d-none d-sm-inline">
                          <a href="https://tmiphp.com" target="_blank"
                             class="text-white-50 text-decoration-none">Powered by TMI.php</a>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <template v-if="statistics">
                ...
                <form @submit.prevent="search">
                    <div class="mb-4">
                        ...
                        <div id="searchHelp" class="form-text">Enter a channel name you want to search.</div>
                    </div>
                </form>
...
export default {
    ...
    methods: {
        search() {
            ...
            this.results = {
                query: this.q,
                data: this.statistics.supervisors.map(supervisor => {
