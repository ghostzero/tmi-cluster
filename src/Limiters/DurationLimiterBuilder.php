...
class DurationLimiterBuilder
{
    ...
    /**
     * The amount of locks, that should be taken per execution.
     *
     * @var int
     */
    public $locks = 1;
    ...
    /**
     * Set the amount of locks, that should be taken per execution.
     *
     * @param int $locks
     * @return $this
     */
    public function take($locks)
    {
        $this->locks = $locks;
    ...
    public function then(callable $callback, callable $failure = null)
    {
        try {
            return (new DurationLimiter(
                $this->connection, $this->name, $this->maxLocks, $this->decay, $this->locks
